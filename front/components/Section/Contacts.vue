<template>
  ...
  >
    ...
    >
      {{ wpData.main_page.contacts_title[locale] }}
    </h1>
    ...
    >
      ...
      >
      <a class="xxsm:w-full" :href="wpData.common.contacts_tg">
        <TheButton
    ...
    >
      <a
        :href="`mailto:${wpData.common.contacts_email.toLowerCase()}`"
      ...
      >
        ...
        <span>{{ wpData.common.contacts_email.toLowerCase() }}</span>
      </a>
      <a
        :href="`tel:${wpData.common.contacts_phone.toLowerCase()}`"
      ...
      >
        ...
        <span>{{ wpData.common.contacts_phone.toLowerCase() }}</span>
      </a>
      <a
        target="_blank"
        :href="wpData.common.contacts_googlemap"
      ...
      >
        ...
        <span class="leading-[25px] xsm:text-left xsm:leading-[19px]" v-html="wpData.common.contacts_address"></span>
      </a>
    </div>
  </div>
  <a
