  ...
  >
    <div class="container">
      <div class="catalog-wrapper mb-[24px] xsm:mb-0 xsm:relative">
        <h2
          v-html="data.main_page.catalog_title[locale]"
        ...
        <p class="catalog-desc section-desc text-center xsm:max-w-[233px] xsm:mb-[3px] xsm:mx-auto">
          {{ data.main_page.catalog_subtitle[locale] }}
        </p>
        <div
    ...
    <div
      class="catalog-arrows pointer-events-none sm:w-full w-[90%] sm:self-center translate-y-[-50%] translate-x-[-50%] left-[50%] gap-[0px] absolute top-[52%] md:top-[35%] justify-between flex select-none z-[2]"
    >
